...
export default function TranscriptTimeline({ title = "Transcript", lines, h = 500 }: Props) {
  return (
    <Box
      bg="white"
      color="black"
    ...
    >
      ...
      <Box as="div" overflowY="auto" pr={2} h={`calc(${typeof h === "number" ? `${h}px` : h} - 40px)`}>
          ...
          {lines.map((line, idx) => {
            ...
            return (
              ...
              >
                ...
                <Box as="span" px="8px" py="2px" borderRadius="6px" bg={badge.bg} color={badge.color} fontWeight={600} whiteSpace="nowrap">
                  {line.speaker}
                </Box>
