    ...
    JSON.stringify(
      [
        ...
        },
        {
          time: "00:00:10.200",
          speaker: "PlayByPlay",
          text: "Johnson brings it over the logo, sets the table for the first set.",
        },
        {
          time: "00:00:12.850",
          speaker: "Color",
          text: "Look for an early touch to Okafor at the elbow—he’s comfortable facing up.",
        },
        {
          time: "00:00:15.300",
          speaker: "PlayByPlay",
          text: "High screen from Carter, Johnson snakes right, bounce pass to Okafor.",
        },
        {
          time: "00:00:18.100",
          speaker: "PlayByPlay",
          text: "Okafor jab step, one dribble… soft floater from eight feet—good! [score: TIG 2–0]",
        },
        {
          time: "00:00:20.000",
          speaker: "Color",
          text: "That’s touch. He sells the jab and keeps the defender on his heels.",
        },
      ],
      null,
      2,
    ...
    >
      ...
      >
        ...
        <Text fontSize="sm" opacity={0.8} mt={1}>
          Two-lane, non-overlapping clips with mini waveforms
        </Text>
      </Box>
